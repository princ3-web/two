    ...
    <>
      <div style={{ display: "block", position: "relative" }}>
        <Paralax
          ...
          objectWidth={45}
        />
        <Infocard info={openingInfos} left={"5rem"} right={"unset"} top={"50vh"} />
      </div>
      ...
      <div style={{ display: "block", position: "relative" }}>
        ...
        />
        <Infocard info={moreInfos} left={"unset"} right={"25rem"} top={"25rem"} />
      </div>
      ...
      <div style={{ display: "block", position: "relative" }}>
        <Paralax
          ...
          object={require("../assets/images/object2.png")}
          right={55}
          objectWidth={20}
        />
