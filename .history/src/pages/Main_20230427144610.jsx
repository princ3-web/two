...
const Main = () => {
  const openingInfos = ["OPENING HOURS:", "Open daily: 9.30am – 6.00am", "Last admission is 5.00pm"];
...
<div className={subpage.paralax}>
          <img className={subpage.paralaxBackground} src={paralaxBackground} style={{top: scrollPos/4 - 50 + "px"}} alt="" />
