  ...
  const items = [
    ...
    useEffect(() => {
      const handleMouseMove = (event) => {
        setScrollPos([event.clientY, event.clientX]);
      };
  
      window.addEventListener("scro", handleMouseMove);
      return () => {
  ...
  return (
    <>
      <div className={subpage.section}>
        <div className={subpage.paralax}>
          <img className={subpage.paralaxBackground} src={paralaxBackground} alt="" />
          <img className={subpage.paralaxObject} src={paralaxObject} alt="" />
        </div>
        <div className={subpage.headerImageWrapper}>
          <img
            className={subpage.headerImage}
            src={require("../assets/images/headerImage" +
