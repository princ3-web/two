...
const Main = () => {
  ...
  const cards = [
    ...
    {
      title: "Membership",
      text: "Information on the different membership options available to zoo visitors, including annual passes and special benefits such as free admission and discounts on zoo merchandise.",
