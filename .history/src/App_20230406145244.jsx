...
function App() {
  ...
  const navbarButtons = [
    { name: "Visit", menu: true, items: ["Plan Your Day", "What's On", "Membership", "Vet Hospital", "Education", "Zoo Map"] },
    {
      name: "Education",
      menu: true,
      items: [
    ...
    { name: "Get involved", menu: true, items: ["What We Do", "What You Can Do", "Work at the Zoo", "Volunteer", "Sponsorship", "Conservation"] },
          ...
          <div className={navbar.navbarButtons}>
            {navbarButtons.map((item) => (
              <div style={{ display: "block", overflow: "visible" }}>
                <div className={navbar.navbarButton} onMouseOver={() => (item.menu ? toggleMenu(true) : toggleMenu(false))}>
                  {item.name + (item.menu ? " ⯆" : "")}
                </div>
