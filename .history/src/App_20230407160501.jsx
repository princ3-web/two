...
function App() {
  ...
  const cards = [
    { text: "Events: This subpage is dedicated to providing information on upcoming events at the zoo, such as animal feedings, live shows, and educational programs.
