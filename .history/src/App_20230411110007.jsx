...
function App() {
  ...
  const cards = [
    ...
    {
      title: " Our animals",
      text: "e different animal species that are on display in the zoo, as well as information about the exhibits and habitats that have been created to replicate their natural environments.",
